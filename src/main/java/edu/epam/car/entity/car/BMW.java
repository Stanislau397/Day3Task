...
public class BMW extends Vehicle {
    ...
    public BMW(String brand, String model, String color, int price) {
        super(brand, model, color, price);
    }

    public BMW(String brand, String model, int releaseYear, int price, int exploitation, String color) {
        super(brand, model, releaseYear, price, exploitation, color);
    }

    public BMW(String brand, String model, int id, String registrationNumber) {
